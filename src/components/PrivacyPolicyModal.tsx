            ...
            <Modal show={show} onHide={handleClose} size="lg">
                ...
                <Modal.Body>
                    ...
                    <div>
                        ...
                        <p className='fs-3'>Interpretation and Definitions</p>
                        <p className='fs-4'>Interpretation</p>
                        <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

                        <p className='fs-4'>Definitions</p>
                        ...
                        <ul>
                            ...
                            <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to i.contest UG, Hauptstraße 30a, 38446, Wolfsburg, Germany.
                            </li>
                            ...
                            <li>Country refers to: Niedersachsen,  Germany
                            </li>
                            ...
                            <li>Website refers to I.CONTEST, accessible from https://i-contest.eu/
                            </li>
                        ...
                        <p className='fs-4'>Collecting and Using Your Personal Data</p>
                        <p className='fs-4'>Types of Data Collected</p>
                        <p>Personal Data</p>
                        ...
                        <p className='fs-4'>Tracking Technologies and Cookies</p>
                        ...
                        <p>
                            ...
                            <li>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the Free Privacy Policy website article.
                            </li>
                        ...
                        <p className='fs-3'>Use of Your Personal Data</p>
                        ...
                        <p className='fs-4'>Retention of Your Personal Data</p>
                        ...
                        <p className='fs-4'>                        Delete Your Personal Data
                        </p>
                        ...
                        <p className='fs-4'>Disclosure of Your Personal Data</p>
                        <p className='fs-5'>Business Transactions</p>

                        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.

                        <p className='fs-4'>Law enforcement</p>

                        Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).

                        <p className='fs-4'>Other legal requirements</p>
                        <p className='fs-5'>The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:
                        </p>
                        ...
                        <p className='fs-4'>Security of Your Personal Data</p>

                        The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.

                        <p className='fs-4'>Children's Privacy</p>
                        ...
                        <p className='fs-4'>Links to Other Websites</p>
                        ...
                        <p className='fs-4'>Changes to this Privacy Policy</p>
                        ...
                        <p className='fs-5 mt-5'>Contact Us</p>

                        If you have any questions about this Privacy Policy, You can contact us:

                        <ul>
                            <li>By email: info@i-contest.eu</li>
                            <li>By phone number: Tel: +49 157 5171551</li>
                        </ul>
